...
export const dict: Record<Locale, Record<string, string>> = {
  ko: {
    ...
    'resume.exportBlocked': '이름·이메일과 경력/학력/프로젝트 중 하나는 채워야 내보낼 수 있습니다',
  ...
  en: {
    ...
    'resume.exportBlocked': 'Add your name, email, and at least one experience, degree, or project to export',
